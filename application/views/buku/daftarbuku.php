          ...
          <div class="col-md-3">
            <div class="thumbnail" style="height: 370px;">
              ...
              <div class="caption">
                ...
                <p>
                  <?php if ($buku->stok < 1) { ?>
                    <i class="btn btn-outline-primary fas fa-shopping-cart"> Booking&nbsp;&nbsp;0</i>
                  <?php } else { ?>
                    <a class="btn btn-outline-primary fas fa-shopping-cart" href="<?= base_url('booking/tambahBooking/' . $buku->id); ?>"> Booking</a>
                  <?php } ?>
